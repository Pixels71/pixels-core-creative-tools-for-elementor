/*!
 * Select2 4.1.0 (MIT) with astselect2 alias
 * https://select2.github.io
 * https://github.com/select2/select2/blob/master/LICENSE.md
 */
(function ($) {
  var existingVersion = $.fn.select2 || null;
  if (existingVersion) {
...
S2.define('jquery.select2',[
  ...
  if ($.fn.select2) {
    $.fn.astselect2 = $.fn.select2;
  }
  if (existingVersion) {
    try { delete $.fn.select2; } catch (e) { /* ignore */ }
    $.fn.select2 = existingVersion;
  }
})(jQuery);
