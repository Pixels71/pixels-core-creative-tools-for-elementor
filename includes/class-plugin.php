...
final class Plugin {
	...
	public function init(): void {
		...
		if ( ! self::is_nested_elements_active() ) {
			add_action( 'admin_notices', array( $this, 'admin_notice_missing_nested_elements' ) );
		}
		...
		require_once PIXECCTE_PATH . 'includes/theme-builder/class-theme-elementor.php';
	...
	/**
	 * Admin notice missing nested elements.
	 */
