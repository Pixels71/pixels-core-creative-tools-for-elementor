...
final class Widget_Registry {
	...
	private array $widgets = [
		...
		'countdown_timer' => [
			...
			'name'        => 'pixels-core-countdown-timer',
			...
			'assets'      => [
				...
				'script_deps' => [ 'jquery', 'elementor-frontend', 'pixels-core-number-flow' ],
			],
		],
		'progress_bar'    => [
			'file'        => 'widgets/class-progress-bar-widget.php',
			'name'        => 'pixels-core-progress-bar',
			'title'       => 'Progress Bar',
