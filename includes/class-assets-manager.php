...
final class Assets_Manager {
	...
	public function register_vendor_scripts(): void {
		...
		wp_register_script(
			'pixels-core-gsap',
			PIXELS_CORE_URL . 'assets/js/vendor/gsap.min.js',
			[],
			'3.12.7',
			true
		);
		...
		wp_register_script(
			'pixels-core-gsap-scroll-trigger',
			PIXELS_CORE_URL . 'assets/js/vendor/ScrollTrigger.min.js',
			[ 'pixels-core-gsap' ],
			'3.12.7',
			true
		);
		...
		wp_register_script(
			'pixels-core-gsap-split-text',
			PIXELS_CORE_URL . 'assets/js/vendor/SplitText.min.js',
			[ 'pixels-core-gsap' ],
			'3.12.5',
			true
		);
