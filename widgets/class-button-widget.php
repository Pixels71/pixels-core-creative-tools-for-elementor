...
class Button_Widget extends Widget_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Button', 'pixels-elementor-addons' );
	}
	...
	public function get_categories(): array {
		return [ 'pixels-elementor-addons' ];
	}
	...
	private function register_content_controls(): void {
		$this->start_controls_section(
			'button_section',
			[
				'label' => esc_html__( 'Button', 'pixels-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			'variation',
			[
				'label'   => esc_html__( 'Variation', 'pixels-elementor-addons' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'variation_1',
				'options' => [
					'variation_1'  => esc_html__( 'Variation 1', 'pixels-elementor-addons' ),
					'variation_2'  => esc_html__( 'Variation 2', 'pixels-elementor-addons' ),
					'variation_3'  => esc_html__( 'Variation 3', 'pixels-elementor-addons' ),
					'variation_4'  => esc_html__( 'Variation 4', 'pixels-elementor-addons' ),
					'variation_5'  => esc_html__( 'Variation 5', 'pixels-elementor-addons' ),
					'variation_6'  => esc_html__( 'Variation 6', 'pixels-elementor-addons' ),
					'variation_7'  => esc_html__( 'Variation 7', 'pixels-elementor-addons' ),
					'variation_8'  => esc_html__( 'Variation 8', 'pixels-elementor-addons' ),
					'variation_9'  => esc_html__( 'Variation 9', 'pixels-elementor-addons' ),
					'variation_10' => esc_html__( 'Variation 10', 'pixels-elementor-addons' ),
				],
			]
		);
		...
		$this->add_control(
			'btn_title',
			[
				'label'       => esc_html__( 'Button Text', 'pixels-elementor-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Get Started', 'pixels-elementor-addons' ),
				'placeholder' => esc_html__( 'Type your title here', 'pixels-elementor-addons' ),
				'dynamic'     => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'btn-xl',
				'options'   => [
					'btn-md' => esc_html__( 'Small', 'pixels-elementor-addons' ),
					'btn-lg' => esc_html__( 'Medium', 'pixels-elementor-addons' ),
					'btn-xl' => esc_html__( 'Large (Default)', 'pixels-elementor-addons' ),
				],
				'condition' => [
		...
		$this->add_control(
			'v1_show_icon',
			[
				'label'     => esc_html__( 'Show Icon', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			'v1_icon_source',
			[
				'label'     => esc_html__( 'Icon Source', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'default',
				'options'   => [
					'default' => esc_html__( 'Default Icon', 'pixels-elementor-addons' ),
					'upload'  => esc_html__( 'Upload Icon', 'pixels-elementor-addons' ),
					'library' => esc_html__( 'Icon Library', 'pixels-elementor-addons' ),
				],
				'condition' => [
					'variation'    => 'variation_1',
					'v1_show_icon' => 'yes',
		...
		$this->add_control(
			'v1_icon_upload',
			[
				'label'     => esc_html__( 'Upload Icon', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			'v1_selected_icon',
			[
				'label'     => esc_html__( 'Icon Library', 'pixels-elementor-addons' ),
	...
	private function register_style_controls(): void {
		$this->start_controls_section(
			'btn_outerstyle',
			[
				'label'     => esc_html__( 'Outer Style', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			'enable_full_width',
			[
				'label'        => esc_html__( 'Enable Full Width', 'pixels-elementor-addons' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Icon Style', 'pixels-elementor-addons' ),
		...
		$this->add_responsive_control(
			'btn_circle_size',
			[
				'label'      => esc_html__( 'Icon Box Size', 'pixels-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Icon Border Radius', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Icon Box Background', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Border Gradient', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'variation' => 'variation_10',
		...
		$this->add_control(
			'v10_gradient_from',
			[
				'label'     => esc_html__( 'Gradient From', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#2BC0E4',
				'selectors' => [
		...
		$this->add_control(
			'v10_gradient_to',
			[
				'label'     => esc_html__( 'Gradient To', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#EAECC6',
				'selectors' => [
		...
		$this->add_control(
			'v10_glow_heading',
			[
				'label'     => esc_html__( 'Glow', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'variation' => 'variation_10',
		...
		$this->add_responsive_control(
			'v10_glow_width',
			[
				'label'      => esc_html__( 'Glow Width', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'v10_glow_height',
			[
				'label'      => esc_html__( 'Glow Height', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Shine Through Color', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	private function register_v3_icon_style_controls(): void {
		...
		$this->add_control(
			'v3_icon_hover_color',
			[
				'label'     => esc_html__( 'Icon Hover Color', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	private function register_v4_icon_style_controls(): void {
		...
		$this->add_responsive_control(
			'v4_gap',
			[
				'label'      => esc_html__( 'Gap Between Icon & Text', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'v4_icon_box_width',
			[
				'label'      => esc_html__( 'Icon Box Width', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'v4_icon_box_height',
			[
				'label'      => esc_html__( 'Icon Box Height', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'v4_icon_box_padding',
			[
				'label'      => esc_html__( 'Icon Box Padding', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors'  => [
	...
	private function register_v8_icon_style_controls(): void {
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Icon Box Hover Background', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	private function render_v4_icon( array $settings ): void {
		...
		if ( 'upload' === $icon_source && ! empty( $settings['v4_icon_upload']['url'] ) ) {
			echo '<img src="' . esc_url( $settings['v4_icon_upload']['url'] ) . '" alt="' . esc_attr__( 'Button Icon', 'pixels-elementor-addons' ) . '" />';
			return;
		}
