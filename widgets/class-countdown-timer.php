...
class Countdown_Timer_Widget extends Widget_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Countdown Timer', 'pixels-elementor-addons' );
	}
	...
	private function register_content_controls(): void {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Countdown Timer', 'pixels-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);

        $this->add_control('due_date', [
            'label' => esc_html__('Due Date', 'pixels-elementor-addons'),
            'type' => Controls_Manager::DATE_TIME,
            'default' => gmdate('Y-m-d H:i', strtotime('+7 days')),
            'description' => esc_html__('Set the target date and time for the countdown.', 'pixels-elementor-addons'),
        ]);

        $this->add_control('show_days', [
            'label' => esc_html__('Show Days', 'pixels-elementor-addons'),
        ...
        $this->add_control('show_hours', [
            'label' => esc_html__('Show Hours', 'pixels-elementor-addons'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Show', 'pixels-elementor-addons'),
            'label_off' => esc_html__('Hide', 'pixels-elementor-addons'),
            'return_value' => 'yes',
        ...
        $this->add_control('show_minutes', [
            'label' => esc_html__('Show Minutes', 'pixels-elementor-addons'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Show', 'pixels-elementor-addons'),
            'label_off' => esc_html__('Hide', 'pixels-elementor-addons'),
            'return_value' => 'yes',
        ...
        $this->add_control('show_seconds', [
            'label' => esc_html__('Show Seconds', 'pixels-elementor-addons'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Show', 'pixels-elementor-addons'),
            'label_off' => esc_html__('Hide', 'pixels-elementor-addons'),
            'return_value' => 'yes',
        ...
        $this->add_control('show_separator', [
            'label' => esc_html__('Show Separator', 'pixels-elementor-addons'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Show', 'pixels-elementor-addons'),
            'label_off' => esc_html__('Hide', 'pixels-elementor-addons'),
            'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Circle Progress', 'pixels-elementor-addons' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'pixels-elementor-addons' ),
                'label_off' => esc_html__( 'Hide', 'pixels-elementor-addons' ),
                'return_value' => 'yes',
        ...
        $this->add_control('days_label', [
            'label' => esc_html__('Days Label', 'pixels-elementor-addons'),
            'type' => Controls_Manager::TEXT,
            'default' => esc_html__('Days', 'pixels-elementor-addons'),
            'condition' => [
                'show_days' => 'yes',
            ],
        ]);
        ...
        $this->add_control('hours_label', [
            'label' => esc_html__('Hours Label', 'pixels-elementor-addons'),
            'type' => Controls_Manager::TEXT,
            'default' => esc_html__('Hours', 'pixels-elementor-addons'),
            'condition' => [
                'show_hours' => 'yes',
            ],
        ]);
        ...
        $this->add_control('minutes_label', [
            'label' => esc_html__('Minutes Label', 'pixels-elementor-addons'),
            'type' => Controls_Manager::TEXT,
            'default' => esc_html__('Minutes', 'pixels-elementor-addons'),
            'condition' => [
                'show_minutes' => 'yes',
            ],
        ]);
        ...
        $this->add_control('seconds_label', [
            'label' => esc_html__('Seconds Label', 'pixels-elementor-addons'),
            'type' => Controls_Manager::TEXT,
            'default' => esc_html__('Seconds', 'pixels-elementor-addons'),
            'condition' => [
                'show_seconds' => 'yes',
            ],
        ]);
        ...
        $this->add_control('expiry_action', [
            'label' => esc_html__('When Timer Ends', 'pixels-elementor-addons'),
            'type' => Controls_Manager::SELECT,
            'default' => 'show_message',
            'options' => [
                'none' => esc_html__('Do Nothing', 'pixels-elementor-addons'),
                'hide' => esc_html__('Hide Timer', 'pixels-elementor-addons'),
                'show_message' => esc_html__('Show Message', 'pixels-elementor-addons'),
            ],
        ]);

        $this->add_control('expiry_message', [
            'label' => esc_html__('Expiry Message', 'pixels-elementor-addons'),
            'type' => Controls_Manager::TEXTAREA,
            'default' => esc_html__('Countdown completed.', 'pixels-elementor-addons'),
            'condition' => [
	...
	private function register_style_controls(): void {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Countdown Timer Items', 'pixels-elementor-addons' ),
		...
		$this->add_responsive_control(
			'unit_item_columns',
			[
				'label'                => esc_html__( 'Columns', 'pixels-elementor-addons' ),
				'type'                 => Controls_Manager::SELECT,
				'default'              => 'auto',
				'tablet_default'       => 'auto',
				'mobile_default'       => '1',
				'options'              => [
					'auto' => esc_html__( 'Auto', 'pixels-elementor-addons' ),
					'1'    => '1',
					'2'    => '2',
					'3'    => '3',
					'4'    => '4',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Countdown Timer Rings', 'pixels-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
		...
		$this->add_responsive_control(
			'ring_size',
			[
				'label'      => esc_html__( 'Circle Size', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'ring_track_color',
			[
				'label'     => esc_html__( 'Circle Track Color', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			'ring_progress_color',
			[
				'label'     => esc_html__( 'Circle Progress Color', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#0b3b25',
				'selectors' => [
		...
		$this->add_control(
			'ring_stroke_width',
			[
				'label'     => esc_html__( 'Circle Stroke Width', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 2,
		...
		$this->add_control(
			'digit_color',
			[
				'label'     => esc_html__( 'Digit Color', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#222222',
				'selectors' => [
		...
		$this->start_controls_section(
			'digit_box_style',
			[
				'label'     => esc_html__( 'Digit Boxes', 'pixels-elementor-addons' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_circle_progress!' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				'label'        => esc_html__( 'Custom Width & Height', 'pixels-elementor-addons' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_responsive_control(
			'digit_box_gap',
			[
				'label'      => esc_html__( 'Gap Between Digits', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Labels', 'pixels-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'ring_label_position',
			[
				'label'        => esc_html__( 'Inside Ring Position', 'pixels-elementor-addons' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'bottom',
				'options'      => [
					'top'    => esc_html__( 'Top', 'pixels-elementor-addons' ),
		...
		$this->add_responsive_control(
			'label_margin_top',
			[
				'label'      => esc_html__( 'Margin Top', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'label_margin_bottom',
			[
				'label'      => esc_html__( 'Margin Bottom', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Separator', 'pixels-elementor-addons' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_separator' => 'yes',
				],
		...
		$this->add_control(
			'separator_style',
			[
				'label'   => esc_html__( 'Style', 'pixels-elementor-addons' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'colon',
				'options' => [
					'colon' => esc_html__( 'Colon', 'pixels-elementor-addons' ),
					'line'  => esc_html__( 'Line', 'pixels-elementor-addons' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Colon', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Line', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::HEADING,
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Top Offset', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
	...
	private function get_timer_unit_definitions(): array {
		return [
			'days'    => esc_html__( 'Days', 'pixels-elementor-addons' ),
			'hours'   => esc_html__( 'Hours', 'pixels-elementor-addons' ),
			'minutes' => esc_html__( 'Minutes', 'pixels-elementor-addons' ),
			'seconds' => esc_html__( 'Seconds', 'pixels-elementor-addons' ),
		];
	}
		...
		$this->start_controls_section(
			...
			[
				'label'     => sprintf(
					...
					esc_html__( '%s Item', 'pixels-elementor-addons' ),
					$label
				),
				'tab'       => Controls_Manager::TAB_STYLE,
	...
	private function register_individual_unit_digit_style_controls( string $unit, string $label ): void {
		...
		$this->start_controls_section(
			...
			[
				'label'     => sprintf(
					/* translators: %s: countdown unit label such as Days or Hours */
					esc_html__( '%s Digits', 'pixels-elementor-addons' ),
					$label
				),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => $visibility,
	...
	private function register_individual_unit_label_style_controls( string $unit, string $label ): void {
		...
		$this->start_controls_section(
			...
			[
				'label'     => sprintf(
					/* translators: %s: countdown unit label such as Days or Hours */
					esc_html__( '%s Label', 'pixels-elementor-addons' ),
					$label
				),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => $visibility,
	...
	private function prepare_timer_data( array $settings ): ?array {
		...
		return [
			...
			'expiry_message'       => $settings['expiry_message'] ?? esc_html__( 'Countdown completed.', 'pixels-elementor-addons' ),
	...
	protected function render(): void {
		...
		$label_map = [
			'days'    => ! empty( $custom_labels['days'] ) ? $custom_labels['days'] : esc_html__( 'Days', 'pixels-elementor-addons' ),
			'hours'   => ! empty( $custom_labels['hours'] ) ? $custom_labels['hours'] : esc_html__( 'Hours', 'pixels-elementor-addons' ),
			'minutes' => ! empty( $custom_labels['minutes'] ) ? $custom_labels['minutes'] : esc_html__( 'Minutes', 'pixels-elementor-addons' ),
			'seconds' => ! empty( $custom_labels['seconds'] ) ? $custom_labels['seconds'] : esc_html__( 'Seconds', 'pixels-elementor-addons' ),
		];
