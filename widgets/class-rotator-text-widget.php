...
class RotatorTextWidget extends Widget_Base {
    ...
    public function get_title(): string {
        return esc_html__( 'Rotator Text', 'pixels-elementor-addons' );
    }
    ...
    private function getLayoutOptions(): array {
        return [
            'single'        => esc_html__( 'Single Rotation Text', 'pixels-elementor-addons' ),
            'dual'          => esc_html__( 'Dual Rotation Text', 'pixels-elementor-addons' ),
            'scroll'        => esc_html__( 'Scroll-Triggered Gauge', 'pixels-elementor-addons' ),
            'ripple'         => esc_html__( 'Concentric Ripple & Pulse', 'pixels-elementor-addons' ),
            'rounded-square' => esc_html__( 'Rounded Square', 'pixels-elementor-addons' ),
        ];
    }
    ...
    private function registerContentControls(): void {
        $this->start_controls_section(
            'section_content',
            [
                'label' => esc_html__( 'Rotator Text', 'pixels-elementor-addons' ),
            ]
        );
        ...
        $this->add_control(
            'layout',
            [
                'label'   => esc_html__( 'Layout Variation', 'pixels-elementor-addons' ),
        ...
        $this->add_control(
            'inner_text',
            [
                'label'       => esc_html__( 'Ring Text', 'pixels-elementor-addons' ),
                'type'        => Controls_Manager::TEXTAREA,
                'default'     => esc_html__( 'CREATING IMPACT BUILDING BRANDS, AND', 'pixels-elementor-addons' ),
                'label_block' => true,
                'dynamic'     => [
                    'active' => true,
                ],
        ...
        $this->add_control(
            'outer_text',
            [
                'label'       => esc_html__( 'Outer Ring Text', 'pixels-elementor-addons' ),
                'type'        => Controls_Manager::TEXTAREA,
                'default'     => esc_html__( 'DESIGN STRATEGY DIGITAL EXPERIENCE INNOVATION', 'pixels-elementor-addons' ),
                'label_block' => true,
                'condition'   => [
                    'layout' => 'dual',
                ],
        ...
        $this->add_control(
            'center_type',
            [
                'label'   => esc_html__( 'Center Content', 'pixels-elementor-addons' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'image',
                'options' => [
                    'image' => esc_html__( 'Image / Logo', 'pixels-elementor-addons' ),
        ...
        $this->add_control(
            'center_image',
            [
                'label'     => esc_html__( 'Center Image', 'pixels-elementor-addons' ),
        ...
        $this->add_control(
            'center_text',
            [
                'label'     => esc_html__( 'Center Text', 'pixels-elementor-addons' ),
                'type'      => Controls_Manager::TEXT,
                'default'   => esc_html__( 'PX', 'pixels-elementor-addons' ),
                'condition' => [
                    'center_type' => 'text',
                ],
                'dynamic'   => [
        ...
        $this->add_control(
            'center_icon',
            [
                'label'     => esc_html__( 'Center Icon', 'pixels-elementor-addons' ),
        ...
        $this->add_control(
            'center_link',
            [
                'label'       => esc_html__( 'Center Link', 'pixels-elementor-addons' ),
    ...
    private function registerAnimationControls(): void {
        $this->start_controls_section(
            'section_animation',
            [
                'label' => esc_html__( 'Animation', 'pixels-elementor-addons' ),
            ]
        );
        ...
        $this->add_control(
            'rotation_speed',
            [
                'label'      => esc_html__( 'Rotation Duration (seconds)', 'pixels-elementor-addons' ),
        ...
        $this->add_control(
            'scroll_sensitivity',
            [
                'label'      => esc_html__( 'Scroll Sensitivity', 'pixels-elementor-addons' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range'      => [
                    'px' => [
        ...
        $this->add_control(
            'show_outer_ring',
            [
                'label'        => esc_html__( 'Show Outer Ring', 'pixels-elementor-addons' ),
        ...
        $this->add_control(
            'ripple_animation',
            [
                'label'   => esc_html__( 'Ripple Animation', 'pixels-elementor-addons' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'pulse',
                'options' => [
                    'pulse'   => esc_html__( 'Pulse', 'pixels-elementor-addons' ),
                    'expand'  => esc_html__( 'Expand & Contract', 'pixels-elementor-addons' ),
                    'breathe' => esc_html__( 'Breathe', 'pixels-elementor-addons' ),
                ],
                'condition' => [
                    'layout' => 'ripple',
                ],
    ...
    private function registerContainerStyleControls(): void {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Container', 'pixels-elementor-addons' ),
    ...
    private function registerRingStyleControls(): void {
        $this->start_controls_section(
            'section_ring_style',
            [
                'label' => esc_html__( 'Text Rings', 'pixels-elementor-addons' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__( 'Inner Ring Typography', 'pixels-elementor-addons' ),
        ...
        $this->add_control(
            'inner_text_color',
            [
                'label'     => esc_html__( 'Inner Ring Color', 'pixels-elementor-addons' ),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__( 'Outer Ring Typography', 'pixels-elementor-addons' ),
        ...
        $this->add_control(
            'outer_text_color',
            [
                'label'     => esc_html__( 'Outer Ring Color', 'pixels-elementor-addons' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#333333',
                'selectors' => [
        ...
        $this->add_responsive_control(
            'ring_gap',
            [
                'label'      => esc_html__( 'Ring Spacing', 'pixels-elementor-addons' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range'      => [
                    'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__( 'Ripple Rings', 'pixels-elementor-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'layout' => 'ripple',
                ],
        ...
        $this->add_control(
            'ripple_width',
            [
                'label'      => esc_html__( 'Border Width', 'pixels-elementor-addons' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range'      => [
                    'px' => [
        ...
        $this->add_control(
            'ripple_duration',
            [
                'label'      => esc_html__( 'Animation Duration (seconds)', 'pixels-elementor-addons' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => [ 's' ],
                'range'      => [
                    's' => [
