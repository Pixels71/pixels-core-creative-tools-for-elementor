...
class Progress_Bar_Widget extends Widget_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Progress Bar', 'pixels-elementor-addons' );
	}
	...
	private function get_variant_definitions(): array {
		return [
			...
			'circle'      => esc_html__( 'Circle', 'pixels-elementor-addons' ),
			'semi-circle' => esc_html__( 'Semi Circle', 'pixels-elementor-addons' ),
		];
	}
	...
	private function register_content_controls(): void {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Progress Bar', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			'fill_type',
			[
				'label'     => esc_html__( 'Fill Style', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'solid',
				'options'   => [
					'solid'    => esc_html__( 'Solid', 'pixels-elementor-addons' ),
					'gradient' => esc_html__( 'Gradient', 'pixels-elementor-addons' ),
					'striped'  => esc_html__( 'Striped', 'pixels-elementor-addons' ),
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Skill Name', 'pixels-elementor-addons' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			'percent',
			[
				'label'   => esc_html__( 'Percentage', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			'description',
			[
				'label'       => esc_html__( 'Description', 'pixels-elementor-addons' ),
				'type'        => Controls_Manager::TEXTAREA,
				'default'     => '',
				'placeholder' => esc_html__( 'Optional description', 'pixels-elementor-addons' ),
				'dynamic'     => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			'show_title',
			[
				'label'        => esc_html__( 'Show Title', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			'show_percent',
			[
				'label'        => esc_html__( 'Show Percentage', 'pixels-elementor-addons' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'pixels-elementor-addons' ),
				'label_off'    => esc_html__( 'Hide', 'pixels-elementor-addons' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'show_description',
			[
				'label'        => esc_html__( 'Show Description', 'pixels-elementor-addons' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'pixels-elementor-addons' ),
				'label_off'    => esc_html__( 'Hide', 'pixels-elementor-addons' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'percent_position',
			[
				'label'     => esc_html__( 'Percentage Position', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'outside',
				'options'   => [
					'outside' => esc_html__( 'Outside Bar', 'pixels-elementor-addons' ),
					'inside'  => esc_html__( 'Inside Bar', 'pixels-elementor-addons' ),
				],
				'condition' => [
					'bar_type'     => [ 'horizontal', 'vertical' ],
					'show_percent' => 'yes',
		...
		$this->add_control(
			'animate',
			[
				'label'        => esc_html__( 'Animate on Scroll', 'pixels-elementor-addons' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'animation_duration',
			[
				'label'      => esc_html__( 'Animation Duration (ms)', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
	...
	private function register_linear_variant_style_controls( string $variant ): void {
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Progress Color', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Progress Border Radius', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
	...
	private function register_horizontal_style_controls(): void {
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Horizontal', 'pixels-elementor-addons' ),
	...
	private function register_vertical_style_controls(): void {
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Vertical', 'pixels-elementor-addons' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'bar_type' => 'vertical',
				],
	...
	private function register_ring_variant_style_controls( string $variant ): void {
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Stroke Width', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 2,
	...
	private function register_circle_style_controls(): void {
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Circle', 'pixels-elementor-addons' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'bar_type' => 'circle',
				],
	...
	private function register_semi_circle_style_controls(): void {
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Semi Circle', 'pixels-elementor-addons' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
