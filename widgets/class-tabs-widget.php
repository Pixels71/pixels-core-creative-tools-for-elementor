...
class Tabs_Widget extends Widget_Nested_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Tabs', 'pixels-elementor-addons' );
	}
		...
		return [
			...
			'settings' => [
				'_title'        => sprintf(
					...
					esc_html__( 'Tab #%d', 'pixels-elementor-addons' ),
					$index
				),
				'content_width' => 'full',
			],
	...
	protected function get_default_children_title(): string {
		/* translators: %d: Tab index. */
		return esc_html__( 'Tab #%d', 'pixels-elementor-addons' );
	}
	...
	private function register_content_controls(): void {
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => esc_html__( 'Tabs', 'pixels-elementor-addons' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Tab Title', 'pixels-elementor-addons' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			'tabs',
			[
				'label'       => esc_html__( 'Tab Items', 'pixels-elementor-addons' ),
				'type'        => Control_Nested_Repeater::CONTROL_TYPE,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[
						'tab_title' => esc_html__( 'Tab #1', 'pixels-elementor-addons' ),
					],
					[
						'tab_title' => esc_html__( 'Tab #2', 'pixels-elementor-addons' ),
					],
					[
						'tab_title' => esc_html__( 'Tab #3', 'pixels-elementor-addons' ),
					],
				],
				'title_field' => '{{{ tab_title }}}',
				'button_text' => esc_html__( 'Add Tab', 'pixels-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			'default_active',
			[
				'label'   => esc_html__( 'Default Active Tab', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			'vertical_position',
			[
				'label'        => esc_html__( 'Tabs Position', 'pixels-elementor-addons' ),
		...
		$this->add_responsive_control(
			'vertical_nav_width',
			[
				'label'      => esc_html__( 'Tabs Width', 'pixels-elementor-addons' ),
		...
		$this->add_responsive_control(
			'vertical_tabs_align',
			[
				'label'     => esc_html__( 'Tabs Alignment', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'flex-start' => [
						'title' => esc_html__( 'Start', 'pixels-elementor-addons' ),
					...
					'flex-end'   => [
						'title' => esc_html__( 'End', 'pixels-elementor-addons' ),
						'icon'  => 'eicon-v-align-bottom',
					],
					'stretch'    => [
						'title' => esc_html__( 'Stretch', 'pixels-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__( 'Content Vertical Align', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'flex-start' => [
	...
	private function register_style_tab_controls(): void {
		$this->start_controls_section(
			'section_style_tabs',
			[
				'label' => esc_html__( 'Tab Titles', 'pixels-elementor-addons' ),
	...
	private function register_style_content_controls(): void {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Content', 'pixels-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
