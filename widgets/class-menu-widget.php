...
class Nav_Menu_Widget extends Widget_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Menu', 'pixels-elementor-addons' );
	}
	...
	private function register_content_controls(): void {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Menu', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			'nav_menu',
			[
				'label'   => esc_html__( 'WordPress Menu', 'pixels-elementor-addons' ),
		...
		$this->start_controls_section(
			'section_responsive',
			[
				'label' => esc_html__( 'Responsive', 'pixels-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'desktop_hamburger',
			[
				'label'              => esc_html__( 'Hamburger on Desktop', 'pixels-elementor-addons' ),
				...
				'description'        => esc_html__( 'Use the hamburger toggle instead of an inline menu on desktop.', 'pixels-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			'mobile_hamburger',
			[
				'label'              => esc_html__( 'Hamburger on Mobile', 'pixels-elementor-addons' ),
				'type'               => Controls_Manager::SWITCHER,
				'label_on'           => esc_html__( 'Yes', 'pixels-elementor-addons' ),
				'label_off'          => esc_html__( 'No', 'pixels-elementor-addons' ),
				'return_value'       => 'yes',
				'default'            => 'yes',
				'frontend_available' => true,
				'description'        => esc_html__( 'Use the hamburger toggle instead of an inline menu below the breakpoint.', 'pixels-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			'breakpoint',
			[
				'label'              => esc_html__( 'Breakpoint', 'pixels-elementor-addons' ),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 1024,
				'min'                => 320,
				'max'                => 1920,
				'frontend_available' => true,
				'description'        => esc_html__( 'Viewport width (px) that separates desktop and mobile menu behavior.', 'pixels-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Hamburger Panel Type', 'pixels-elementor-addons' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'aside',
				'options' => [
					'aside'    => esc_html__( 'Aside (Slide-in)', 'pixels-elementor-addons' ),
					'dropdown' => esc_html__( 'Dropdown', 'pixels-elementor-addons' ),
				],
			]
		);
		...
		$this->add_control(
			'aside_position',
			[
				'label'     => esc_html__( 'Aside Position', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::CHOOSE,
				'default'   => 'left',
				'options'   => [
					'left'  => [
		...
		$this->add_control(
			'lock_body_scroll',
			[
				'label'              => esc_html__( 'Lock Body Scroll', 'pixels-elementor-addons' ),
				'type'               => Controls_Manager::SWITCHER,
				'label_on'           => esc_html__( 'Yes', 'pixels-elementor-addons' ),
				'label_off'          => esc_html__( 'No', 'pixels-elementor-addons' ),
				'return_value'       => 'yes',
		...
		$this->add_control(
			'mobile_toggle_label',
			[
				'label'   => esc_html__( 'Hamburger Label', 'pixels-elementor-addons' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Menu', 'pixels-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__( 'Close on Outside Click', 'pixels-elementor-addons' ),
				'type'               => Controls_Manager::SWITCHER,
				'label_on'           => esc_html__( 'Yes', 'pixels-elementor-addons' ),
				'label_off'          => esc_html__( 'No', 'pixels-elementor-addons' ),
				'return_value'       => 'yes',
		...
		$this->add_control(
			'close_on_link_click',
			[
				'label'              => esc_html__( 'Close on Link Click', 'pixels-elementor-addons' ),
				'type'               => Controls_Manager::SWITCHER,
				'label_on'           => esc_html__( 'Yes', 'pixels-elementor-addons' ),
				'label_off'          => esc_html__( 'No', 'pixels-elementor-addons' ),
				'return_value'       => 'yes',
	...
	private function register_style_controls(): void {
		...
		$this->start_controls_section(
			'section_style_menu',
			[
				'label' => esc_html__( 'Menu Items', 'pixels-elementor-addons' ),
		...
		$this->add_responsive_control(
			'menu_item_gap',
			[
				'label'      => esc_html__( 'Item Spacing', 'pixels-elementor-addons' ),
		...
		$this->add_responsive_control(
			'menu_item_padding',
			[
				'label'      => esc_html__( 'Item Padding', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Divider', 'pixels-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'options' => [
					''       => esc_html__( 'None', 'pixels-elementor-addons' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Submenu', 'pixels-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'submenu_min_width',
			[
				'label'      => esc_html__( 'Min Width', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'submenu_padding',
			[
				'label'      => esc_html__( 'Panel Padding', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em' ],
				'selectors'  => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown Indicator', 'pixels-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'        => esc_html__( 'Show Indicator', 'pixels-elementor-addons' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Hamburger Toggle', 'pixels-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'toggle_size',
			[
				'label'      => esc_html__( 'Button Size', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [ 'min' => 24, 'max' => 80 ],
		...
		$this->add_responsive_control(
			'toggle_bar_width',
			[
				'label'      => esc_html__( 'Bar Width', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [ 'min' => 12, 'max' => 40 ],
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Bar Thickness', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [ 'min' => 1, 'max' => 8 ],
		...
		$this->add_responsive_control(
			'toggle_bar_gap',
			[
				'label'      => esc_html__( 'Bar Gap', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [ 'min' => 2, 'max' => 12 ],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Hamburger Panel', 'pixels-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'aside_width',
			[
				'label'      => esc_html__( 'Aside Width', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'vw' ],
				'range'      => [
					'px' => [ 'min' => 200, 'max' => 600 ],
		...
		$this->add_responsive_control(
			'mobile_panel_offset',
			[
				'label'      => esc_html__( 'Dropdown Top Offset', 'pixels-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'range'      => [
					'px' => [ 'min' => 0, 'max' => 60 ],
		...
		$this->add_control(
			'overlay_heading',
			[
				'label'     => esc_html__( 'Aside Overlay', 'pixels-elementor-addons' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	private function get_wp_nav_menus(): array {
		$options = [
			'' => esc_html__( '— Select —', 'pixels-elementor-addons' ),
		];
	...
	protected function render(): void {
		...
		if ( empty( $settings['nav_menu'] ) ) {
			if ( $this->is_editor_preview() ) {
				...
				echo esc_html__( 'Select a WordPress menu in the widget settings.', 'pixels-elementor-addons' );
				echo '</div>';
			}
		...
		$toggle_label = ! empty( $settings['mobile_toggle_label'] )
			...
			: esc_html__( 'Menu', 'pixels-elementor-addons' );
		$nav_classes  = [
			'pixels-core-menu',
		...
		$this->add_render_attribute( 'close', 'aria-label', esc_html__( 'Close menu', 'pixels-elementor-addons' ) );
			...
			<div <?php $this->print_render_attribute_string( 'wrap' ); ?>>
				<?php if ( 'aside' === $panel_type ) : ?>
					<button <?php $this->print_render_attribute_string( 'close' ); ?>>
						...
						<span class="screen-reader-text"><?php esc_html_e( 'Close menu', 'pixels-elementor-addons' ); ?></span>
					</button>
				<?php endif; ?>
				<?php
				wp_nav_menu(
